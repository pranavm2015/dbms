...
def student(request):
	...
	if request.method=="POST":
	    try:
	        ...
	        return render (request, "success.html", {"data" : "Your Application has been submitted"})
...
def profreg(request):
	...
	if request.method=="POST" :
	    try:
	        ...
	        return render (request, "success.html", {"data" : "registered Successfully"})
...
def select(request):
	if request.method=="POST":
		...
		for key, value in form.items():
	        ...
	        return render (request, "success.html", {"data" : "Your Response has been recorded"})